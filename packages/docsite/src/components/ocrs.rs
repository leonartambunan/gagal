...
pub(crate) mod ocr_hero;

#[component]
pub(crate) fn OCRS() -> Element {
    rsx! {
        div { class: "w-full",
            ocr_hero::OCRHero {}
        }
...
fn OcrTriShow(
    ...
    rsx! {
        ...
        div { class: "w-full flex flex-row ustify-center max-w-screen-lg",
                Link { to: to.clone(),
...
#[component]
fn OcrTriPadding(children: Element, last: bool) -> Element {
    rsx!(
...
#[component]
fn OcrExperienceText(title: &'static str, content: &'static str) -> Element {
    rsx!(
        div { class: "pb-12",
...
#[component]
fn OcrStatsItem(major: String, minor: String) -> Element {
    rsx! {
